...
namespace Pctco\Coding\QRCode\Reader\Qrcode;

require_once('detector/Detectors.php');

use Pctco\Coding\QRCode\Reader\BarcodeFormat;
use Pctco\Coding\QRCode\Reader\BinaryBitmap;
use Pctco\Coding\QRCode\Reader\ChecksumException;
use Pctco\Coding\QRCode\Reader\DecodeHintType;
use Pctco\Coding\QRCode\Reader\FormatException;
use Pctco\Coding\QRCode\Reader\NotFoundException;
use Pctco\Coding\QRCode\Reader\Reader;
use Pctco\Coding\QRCode\Reader\Result;
use Pctco\Coding\QRCode\Reader\ResultMetadataType;
use Pctco\Coding\QRCode\Reader\ResultPoint;
use Pctco\Coding\QRCode\Reader\Common\BitMatrix;
use Pctco\Coding\QRCode\Reader\Common\DecoderResult;
use Pctco\Coding\QRCode\Reader\Common\DetectorResult;
use Pctco\Coding\QRCode\Reader\Qrcode\Decoder\Decoder;
use Pctco\Coding\QRCode\Reader\Qrcode\Decoder\QRCodeDecoderMetaData;
use Pctco\Coding\QRCode\Reader\Qrcode\Detector\Detectors;
...
class QRCodeReader implements Reader {
    ...
    public function decode($image, $hints=null){/* Map<DecodeHintType,?> hints*/
        ...
        if ($hints != null && $hints['PURE_BARCODE']) {//hints.containsKey(DecodeHintType.PURE_BARCODE)) {
            ...
            $detector = new Detectors($image->getBlackMatrix());
